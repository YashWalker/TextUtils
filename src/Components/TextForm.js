  ...
  return (
    <>
      ...
      >
        ...
        <button className="btn btn-primary mx-2 my-2" onClick={reClick}>
          Reverse the Text
        </button>
        <button className="btn btn-primary mx-2 my-2" onClick={rmClick}>
          Remove Extra Spaces
        </button>
        <button className="btn btn-primary mx-2 my-2" onClick={coClick}>
          Copy Text
        </button>
